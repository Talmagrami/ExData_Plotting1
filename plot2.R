...
# Plot Scatterplot for Global Active Power data into file device PNG 'plot2.png'
png("./Projects/project1/plot2.png", width = 480, height = 480)
plot(DT_Feb$datetime, DT_Feb$Global_active_power, xlab = "", ylab = "Global Active Power (kilowatts)", type = "l")
dev.off()